...
const ActiveCrimesCards: React.FC<ActiveCrimesCardsProps> = ({
  ...
  return (
    <>
      {showCard && (
        <div className="card w-96 bg-gray-700 text-neutral-content self-start threedbox">
          <div className="card-body text-center flex-nowrap">
            ...
            <div className="card-actions justify-around flex-nowrap items-center ">
              <div className="italic">{descriptionOfIncident}</div>
              <div>
            ...
            <div className="collapse collapse-arrow">
              ...
              <div className="collapse-title text-xl font-medium flex justify-between ">
                Address
                <div className="card-title text-xl">Time: {timeOfIncident}</div>
              </div>
              <div className="collapse-content border-transparent bg-white text-black rounded-xl ">
                <p>{address}</p>
